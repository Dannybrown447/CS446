 ...
 *
 */
  std::queue<std::vector<cycleInfo> > createSJFqueue(std::vector<cycleInfo>);
 ...
 *
 */
  std::queue<std::vector<cycleInfo> > createPSqueue(std::vector<cycleInfo>);
